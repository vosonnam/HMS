...
<?php include('include/sidebar.php');?>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									<h5 style="color: green; font-size:18px; " class="msgsucces"></h5>
									<h5 style="color: green; font-size:18px; " class="msgerror"></h5>
									<div class="row margin-top-30">
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Thay Đổi Thông Tin Bác Sĩ</h5>
												</div>
												<div class="panel-body">
													<h4 class="doctorName"></h4>
													<p class="creationDate"></p>
													<p class="updationDate" hidden></p>
													<hr />
	...
	<?php include('include/setting.php');?>
		...
		<script type = "text/javascript" src="jsuser/edit-doctor.js"></script>
		<script>
