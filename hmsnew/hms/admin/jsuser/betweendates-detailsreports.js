...
function loadData(page,record) { 
    ...
    var dataSend={
      ...
      page:page,
      records:record,
      fromdate:sessionStorage.getItem("reportsfromdate"),
      todate:sessionStorage.getItem("reportstodate")
    }
...
function showData (data) {
  ...
  for (row in rows){
    ...
    html+='<td >';
    html+='  <a class="btn btn-transparent btn-xs btn_view" tooltip-placement="top" tooltip="Edit"><i class="fa fa-eye"></i></a>';
    html+='</td>';
    html+='</tr>';
  }
  $(".tb_data").html(html);
