...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Bệnh Nhân Xem <span class="text-bold">Tiền Sử Bệnh</span></h5>
 ...
 <td colspan="4" style="font-size:20px;color:blue">
	...
	<tr>
		<th>Tiền Sử Bệnh(Nếu Có)</th><td class="PatientMedhis"></td>
		 <th>Ngày Đăng Ký Khám</th><td class="CreationDate"></td>
	</tr>
</table>
...
<div class="ls_numberpage"></div>              
	...
	<?php include('include/setting.php');?>
		...
		<script src="jsuser/view-medhistory.js"></script>
		<script>
